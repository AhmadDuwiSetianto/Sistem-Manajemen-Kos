                    ...
                    <div class="mb-6 md:mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                            ...
                            <div>
                                ...
                                <select name="role" class="w-full px-3.5 py-2.5 bg-white border border-border rounded-xl focus:ring-2 focus:ring-primary/20 outline-none text-sm transition-all appearance-none cursor-pointer" required>
        ...
        <div class="lg:col-span-1">
            <div class="bg-primary/5 border border-primary/20 rounded-2xl p-5 sticky top-8">
                ...
                <ul class="space-y-2 text-xs md:text-sm text-foreground">
                    <li class="flex gap-2 items-start"><i data-lucide="check" class="size-3.5 md:size-4 text-primary shrink-0 mt-0.5"></i> Gunakan email yang valid dan aktif.</li>
                    <li class="flex gap-2 items-start"><i data-lucide="check" class="size-3.5 md:size-4 text-primary shrink-0 mt-0.5"></i> Kombinasi huruf dan angka untuk password yang kuat.</li>
                    <li class="flex gap-2 items-start"><i data-lucide="check" class="size-3.5 md:size-4 text-primary shrink-0 mt-0.5"></i> Admin memiliki kontrol penuh atas sistem ini.</li>
                </ul>
            </div>
        </div>
    </div>
