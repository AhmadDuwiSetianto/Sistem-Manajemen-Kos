...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 text-sm mt-2">Bergabunglah untuk mulai mencari kos impian Anda</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 p-8">
            ...
            <form action="{{ route('register') }}" method="POST" id="registerForm" class="space-y-5">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-slate-700 mb-1.5">Konfirmasi Sandi</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                            <i class="fas fa-lock text-xs"></i>
                        </div>
                        ...
                        <button type="button" onclick="togglePassword('password_confirmation')" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600 transition-colors">
                            <i class="far fa-eye" id="passwordConfirmationToggle"></i>
                        </button>
                    </div>
                </div>

                <div class="flex items-start gap-3 pt-2">
                    <input type="checkbox" id="terms" name="terms" required class="mt-1 w-4 h-4 text-brand-600 border-gray-300 rounded focus:ring-brand-500">
                    <label for="terms" class="text-xs text-slate-500 leading-relaxed">
                        Dengan mendaftar, saya menyetujui <a href="#" class="text-brand-600 hover:text-brand-700 font-medium hover:underline">Syarat & Ketentuan</a> serta <a href="#" class="text-brand-600 hover:text-brand-700 font-medium hover:underline">Kebijakan Privasi</a> yang berlaku.
                    </label>
                </div>
        ...
        <p class="text-center text-slate-500 text-sm mt-8">
            Sudah punya akun? 
            <a href="{{ route('login') }}" class="text-brand-600 font-semibold hover:text-brand-700 hover:underline transition-all">Masuk di sini</a>
        </p>
    </div>
