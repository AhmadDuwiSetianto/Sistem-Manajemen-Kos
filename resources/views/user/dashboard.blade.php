...
<div class="w-full max-w-6xl mx-auto px-4 md:px-0 pb-10">
                ...
                <div class="lg:col-span-8 xl:col-span-9 flex flex-col justify-center space-y-4 md:space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                        ...
                        <div class="bg-slate-50 p-3 md:p-4 rounded-xl border border-border">
                            <p class="text-[9px] md:text-[10px] font-bold text-secondary uppercase tracking-widest mb-1 md:mb-1.5 flex items-center gap-1 md:gap-1.5"><i data-lucide="clock-4" class="size-3 md:size-3.5"></i> Waktu Booking</p>
                        ...
                        <div class="bg-slate-50 p-3 md:p-4 rounded-xl border border-border sm:col-span-2">
                            <p class="text-[9px] md:text-[10px] font-bold text-secondary uppercase tracking-widest mb-1.5 md:mb-2">Periode Inap (Durasi: {{ $theBooking->durasi }} Bulan)</p>
                            <div class="flex flex-wrap sm:flex-nowrap items-center gap-2 md:gap-3 text-xs md:text-sm font-semibold text-foreground bg-white p-2 md:p-2.5 rounded-lg border border-border/50 w-full sm:w-max justify-center sm:justify-start">
                                <span class="flex items-center gap-1 md:gap-1.5"><i data-lucide="log-in" class="size-3.5 md:size-4 text-primary"></i> {{ \Carbon\Carbon::parse($theBooking->tanggal_masuk)->translatedFormat('d M Y') }}</span>
                                <i data-lucide="arrow-right" class="size-3 text-secondary mx-0.5 md:mx-1 hidden sm:block"></i>
                                <span class="text-secondary sm:hidden text-[10px]">s/d</span>
                                <span class="flex items-center gap-1 md:gap-1.5"><i data-lucide="log-out" class="size-3.5 md:size-4 text-error"></i> {{ \Carbon\Carbon::parse($theBooking->tanggal_keluar)->translatedFormat('d M Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-border overflow-hidden">
        ...
        <!-- Wrapper Scroll-X khusus untuk tabel di Mobile -->
